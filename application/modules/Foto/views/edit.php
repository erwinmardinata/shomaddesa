  ...
  <div class="row">
	...
	<div class="col-md-12">
	  ...
	  <div class="box box-primary">
		...
		<!-- /.box-header -->
		<!-- form start -->
		<form role="form" method="post" action="<?php echo site_url('Foto/update'); ?>" enctype="multipart/form-data">
		  <div class="box-body">
					  ...
					  <div class="row">
						  <div class="col-sm-9">
							  <select name="id_kategori_foto" class="form-control" required>
								...
								<option <?php echo $data->id_kategori_foto==$row->id?"selected":""; ?> value="<?php echo $row->id; ?>"><?php echo $row->kategori; ?></option>
								<?php endforeach; ?>
							  </select>
						  </div>
						  <div class="col-sm-3">
							<a href="<?php echo site_url('Kategori_foto'); ?>" class="btn btn-secondary">+ Uraian</a>
						  </div>
					  </div>
					</div>
				<div class="form-group">
