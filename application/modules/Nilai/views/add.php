...
<form method="POST" action="<?php echo site_url('Nilai/insert'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-12">
	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
            ...
            <div class="form-group">
    				  ...
    				  <input type="text" name="bulan" value="<?php echo date('m'); ?>" class="form-control" required>
    				</div>
            <div class="form-group">
    				  <label for="name">Tahun</label>
    				  <input type="text" name="tahun" value="<?php echo date('Y'); ?>" class="form-control" required>
    				</div>
    				<div class="form-group">
