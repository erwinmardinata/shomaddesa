<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li><a href="<?php echo site_url('Pengaduans'); ?>">Pengaduan</a></li>
  ...
  <div class="col-md-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo $data->nama_pengadu; ?></h3>
      </div>
      <!-- /.box-header -->
      <div class="box-body no-padding">
        <div class="mailbox-read-info">
          <h3><?php echo $data->judul_pengaduan; ?></h3>
              ...
              <span style="float: right"><small><?php echo $row->waktu; ?></small></span>
                <div class="media">
                  ...
                  <div class="media-body" style="font-size: 14px">
                    ...
                    <a href="<?php echo site_url('Pengaduans/hapus_basalan/'.$row->id.'/'.$data->id); ?>" onclick="return confirm('Anda Yakin')" class="btn btn-xs btn-danger" style="margin-top: -14px;float: right;">hapus</a>
                  </div>
                </div>
            <?php endforeach; } ?>
            </li>
      ...
      <!-- /.box-body -->
      <form method="post" action="<?php echo site_url('Pengaduans/inserts'); ?>">
      <div class="box-footer">
        <div style="font-weight: bold;padding: 9px 0;">Balas :</div>
        <input type="hidden" name="id_pengaduan" value="<?php echo $data->id; ?>">
      ...
      <div class="box-footer">
        ...
        <a href="<?php echo site_url('Pengaduans/hapus/'.$data->id); ?>" onclick="return confirm('Anda Yakin')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
        <a href="<?php echo site_url('Pengaduans'); ?>" class="btn btn btn-warning">
