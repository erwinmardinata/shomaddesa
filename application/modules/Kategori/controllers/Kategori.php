...
class Kategori extends Back_controller {
	...
	function get_data() {
		...
		foreach($fetch_data as $row)
		{
				 ...
				 $sub_array[] = '<a href="'.site_url('Kategori/edit/'.$row->id).'" class="btn btn-info btn-xs update">Edit</a>
				 <a href="'.site_url('Kategori/hapus/'.$row->id).'" onclick="return confirm(\'Anda Yakin?\')" class="btn btn-danger btn-xs delete">Delete</a>';
				 $data[] = $sub_array;
		}
		$output = array(
