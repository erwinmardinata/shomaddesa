...
class Kategori_info extends Back_controller {

	function __construct() {

		parent::__construct();
		$this->load->model('Mkategori_info', 'mdl');
	...
	function index() {
		...
		$title = "Data Kategori Info";
		$subtitle = "kategori info";
	...
	function add() {
		...
		$title = "Tambah Data Kategori Info";
		$subtitle = "kategori info";
	...
	function get_data() {
		...
		foreach($fetch_data as $row)
		{
				 ...
				 $sub_array[] = '<a href="'.site_url('Kategori_info/edit/'.$row->id).'" class="btn btn-info btn-xs update">Edit</a>
				 <a href="'.site_url('Kategori_info/hapus/'.$row->id).'" onclick="return confirm(\'Apakah Anda Yakin?\')" class="btn btn-danger btn-xs delete">Delete</a>';
				 $data[] = $sub_array;
		}
		$output = array(
