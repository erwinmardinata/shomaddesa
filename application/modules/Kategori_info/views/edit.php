<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li><a href="<?php echo site_url('Kategori_info'); ?>">Kategori Info</a></li>
...
<form method="POST" action="<?php echo site_url('Kategori_info/update'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-12">
	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
          ...
          <div class="card-footer">
            <a href="<?php echo site_url('Kategori_info'); ?>" class="btn btn-sm btn-warning">
