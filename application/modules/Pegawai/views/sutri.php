				...
				<div class="row">
					<div class="col-sm-3">
						<div class="list-group">
						  ...
						  <a href="<?php echo site_url('Pegawai/sutri/'.$data->id); ?>" class="list-group-item list-group-item-action active">
							Data Suami/Istri
						  </a>
						  ...
						  <a href="<?php echo site_url('Pegawai/peng_keahlian/'.$data->id); ?>" class="list-group-item list-group-item-action">
					  ...
					  <dl class="row">
						...
						<div class="row">
							  ...
							  <div class="modal-dialog" role="document">
								<div class="modal-content">
								  <div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel">Tambah data Suami/Istri</h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									  <span aria-hidden="true">&times;</span>
									</button>
								  </div>
								  <div class="modal-body">
									<form method="post" action="<?php echo site_url('Pegawai/insert_sutri'); ?>">
									  <div class="form-group row">
									    <div class="col-sm-12">
									      <input type="hidden" name="id_pegawai" value="<?php echo $data->id; ?>" class="form-control" id="inputPassword" placeholder="Nama">
									      <input type="text" name="nama_sutri" class="form-control" id="inputPassword" placeholder="Nama" required="">
									    </div>
									  </div>
									  <div class="form-group row">
									    <div class="col-sm-12">
									  ...
									  <div class="form-group row">
									    <div class="col-sm-12">
									      <input type="text" name="pekerjaan" class="form-control" id="inputPassword" placeholder="Pekerjaan" required="">
									    </div>
									  </div>
									  <div class="form-group row">
									    <div class="col-sm-12">
							...
							<table class="table" style="margin-top: 20px">
								...
								<?php $no=1; foreach($sutri as $row): ?>
								<tr>
									<td><?php echo $no++; ?></td>
									<td><?php echo $row->nama_sutri; ?></td>
									...
									<td width="15%">
										...
										<a href="<?php echo site_url('Pegawai/hapus_sutri/'.$row->id.'/'.$row->id_pegawai); ?>" onclick="return confirm('Anda yakin?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>										
									</td>
								</tr>
								<!-- Modal -->
								<div class="modal fade" id="exampleModal<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  <div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Edit data Suami/Istri</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										  <span aria-hidden="true">&times;</span>
										</button>
									  </div>
									  <div class="modal-body">
										<form method="post" action="<?php echo site_url('Pegawai/update_sutri'); ?>">
										  <div class="form-group row">
										    <div class="col-sm-12">
										      ...
										      <input type="text" name="nama_sutri" value="<?php echo $row->nama_sutri; ?>" class="form-control" id="inputPassword" placeholder="Nama" required="">
										    </div>
										  </div>
										  <div class="form-group row">
										    <div class="col-sm-12">
										  ...
										  <div class="form-group row">
										    <div class="col-sm-12">
										      <input type="text" name="pekerjaan" value="<?php echo $row->pekerjaan; ?>" class="form-control" id="inputPassword" placeholder="Pekerjaan" required="">
										    </div>
										  </div>
										  <div class="form-group row">
										    <div class="col-sm-12">
