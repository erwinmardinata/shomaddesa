				...
				<div class="row">
					<div class="col-sm-3">
						<div class="list-group">
						  ...
						  <a href="<?php echo site_url('Pegawai/peng_panitia/'.$data->id); ?>" class="list-group-item list-group-item-action active">
					  ...
					  <dl class="row">
						...
						<div class="row">
							  ...
							  <div class="modal-dialog" role="document">
								<div class="modal-content">
								  <div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel">Tambah data Pengalaman Lainnya</h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									  <span aria-hidden="true">&times;</span>
									</button>
								  </div>
								  <div class="modal-body">
									<form method="post" action="<?php echo site_url('Pegawai/insert_peng_panitia'); ?>">
									  <div class="form-group row">
									    <div class="col-sm-12">
									      <input type="hidden" name="id_pegawai" value="<?php echo $data->id; ?>" class="form-control" id="inputPassword" placeholder="Nama">
									      <input type="text" name="nama_pengalaman" class="form-control" id="inputPassword" placeholder="Nama Pengalaman" required="">
									    </div>
									  </div>
									  <div class="form-group row">
									    <div class="col-sm-12">
									      <input type="text" name="tahun" class="form-control" id="inputPassword" placeholder="Tahun" required="">
									    </div>
									  </div>
								  </div>
							...
							<table class="table" style="margin-top: 20px">
								<tr>
									<td>No</td>
									<td>Nama Pengalaman</td>
									<td>Tahun</td>
									<td></td>
								</tr>
								<?php $no=1; foreach($peng_panitia as $row): ?>
								<tr>
									<td><?php echo $no++; ?></td>
									<td><?php echo $row->nama_pengalaman; ?></td>
									<td><?php echo $row->tahun; ?></td>
									<td width="15%">
										<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?php echo $row->id; ?>">
										  <i class="fa fa-edit"></i>
										</button>
										<a href="<?php echo site_url('Pegawai/hapus_peng_panitia/'.$row->id.'/'.$row->id_pegawai); ?>" onclick="return confirm('Anda yakin?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>										
									</td>
								</tr>
								<!-- Modal -->
								<div class="modal fade" id="exampleModal<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  <div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Edit data Pengalaman Lain-lain</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										  <span aria-hidden="true">&times;</span>
										</button>
									  </div>
									  <div class="modal-body">
										<form method="post" action="<?php echo site_url('Pegawai/update_peng_panitia'); ?>">
										  <div class="form-group row">
										    <div class="col-sm-12">
										      ...
										      <input type="text" name="nama_pengalaman" value="<?php echo $row->nama_pengalaman; ?>" class="form-control" id="inputPassword" placeholder="Nama" required="">
										    </div>
										  </div>
										  <div class="form-group row">
										    <div class="col-sm-12">
										      <input type="text" name="tahun" value="<?php echo $row->tahun; ?>" class="form-control" id="inputPassword" placeholder="Tempat Lahir" required="">
										    </div>
										  </div>
									  </div>
									  <div class="modal-footer">
