				...
				<div class="rows">
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="nik" required value="<?php echo $data->nik; ?>" id="first_name" placeholder="NIK" title="enter your first name if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
								<label for="last_name">Nama Lengkap*</label>
										<input type="text" class="form-control" name="nama" required value="<?php echo $data->nama; ?>" id="last_name" placeholder="Nama Lengkap" title="enter your last name if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="no_kk_sebelumnya" value="<?php echo $data->no_kk_sebelumnya; ?>" id="phone" placeholder="Nomor KK Sebelumnya" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Nomor KK Sekarang</label> <code>diisi sesuai dengan KK sekarang</code>
									<input type="text" class="form-control" name="no_kk_sekarang" value="<?php echo $data->no_kk_sekarang; ?>" id="phone" placeholder="Nomor KK Sebelumnya" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="akta_lahir" value="<?php echo $data->akta_lahir; ?>" id="phone" placeholder="Nomor Akta Kelahiran" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-8" style="margin-bottom: 15px;">
									<label for="phone">Tempat Lahir</label>
									<input type="text" class="form-control" name="tempatlahir" value="<?php echo $data->tempatlahir; ?>" id="phone" placeholder="Tempat Lahir" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									<label for="phone">Tanggal Lahir</label>
									<input type="date" class="form-control" name="tanggallahir" value="<?php echo $data->tanggallahir; ?>" id="phone" placeholder="Tanggal Lahir" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									<label for="phone">Waktu Kelahiran</label>
									<input type="time" class="form-control" name="waktu_lahir" value="<?php echo $data->waktu_lahir; ?>" id="phone" placeholder="Waktu Kelahiran" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="kelahiran_anak_ke" value="<?php echo $data->kelahiran_anak_ke; ?>" id="phone" placeholder="Anak Ke" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="berat_lahir" value="<?php echo $data->berat_lahir; ?>" id="phone" placeholder="Berat Lahir" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									<label for="phone">Panjang Lahir</label> &nbsp;<code>cm</code>
									<input type="text" class="form-control" name="panjang_lahir" value="<?php echo $data->panjang_lahir; ?>" id="phone" placeholder="Panjang Lahir" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="dokumen_pasport" value="<?php echo $data->dokumen_pasport; ?>" id="phone" placeholder="Nomor Paspor" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Tanggal Berakhir Paspor</label>
									<input type="date" class="form-control" name="tanggal_akhir_paspor" value="<?php echo $data->tanggal_akhir_paspor; ?>" id="phone" placeholder="Email" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Nomor KITAS/KITAP</label>
									<input type="text" class="form-control" name="dokumen_kitas" value="<?php echo $data->dokumen_kitas; ?>" id="phone" placeholder="Nomor KITAS/KITAP" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="ayah_nik" value="<?php echo $data->ayah_nik; ?>" id="phone" placeholder="NIK Ayah" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Nama Ayah</label>
									<input type="text" class="form-control" name="nama_ayah" id="phone" value="<?php echo $data->nama_ayah; ?>" placeholder="Nama Ayah" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">NIK Ibu</label>
									<input type="text" class="form-control" name="ibu_nik" id="phone" value="<?php echo $data->ibu_nik; ?>" placeholder="Nama Ibu" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Nama Ibu</label>
									<input type="text" class="form-control" name="nama_ibu" id="phone" value="<?php echo $data->nama_ibu; ?>" placeholder="Nama Ibu" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
							...
							<div class="col-md-4" style="margin-bottom: 15px;">
									...
									<select class="form-control" name="dusun_id" id="dusun" required>
										...
										<?php foreach($dusun as $row): ?>
											<option <?php echo $data->dusun_id==$row->id?"selected":""; ?> value="<?php echo $row->id; ?>"><?php echo $row->nama; ?></option>
										<?php endforeach; ?>
									</select>
							</div>
					</div>
					<div id="value">
				  <?php
						$cek = $this->db->where('id', $data->dusun_id)->get('dusun')->row();
						$rw = $cek->rw;
						$rt = $cek->rt;
					?>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
								...
								<input required type="text" class="form-control" value="<?php echo $data->rw_id; ?>" name="rw_id" id="phone" placeholder="RW" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-4" style="margin-bottom: 15px;">
									<label for="phone">RT* <small>Format 001</small></label>
									<input required type="text" class="form-control" value="<?php echo $data->rt_id; ?>" name="rt_id" id="phone" placeholder="RT" title="enter your phone number if any.">
							</div>
					</div>
					...
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="telepon" value="<?php echo $data->telepon; ?>" id="phone" placeholder="Telepon" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
									<label for="phone">Alamat Sebelumnya</label>
									<input type="text" class="form-control" name="alamat_sebelumnya" value="<?php echo $data->alamat_sebelumnya; ?>" id="phone" placeholder="Alamat Sebelumnya" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
									<label for="phone">Alamat Sekarang</label>
									<input type="text" class="form-control" name="alamat_sekarang" value="<?php echo $data->alamat_sekarang; ?>" id="phone" placeholder="Alamat Sekarang" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
					...
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<input type="text" class="form-control" name="akta_perkawinan" value="<?php echo $data->akta_perkawinan; ?>" id="phone" placeholder="Nomor Akta Nikah (Buku Nikah)/Perkawinan" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Tanggal Perkawinan</label> &nbsp;<code>(Wajib diisi apabila status KAWIN)</code>
									<input type="date" class="form-control" name="tanggalperkawinan" value="<?php echo $data->tanggalperkawinan; ?>" id="phone" placeholder="Tanggal Perkawinan" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Akta Perceraian</label>
									<input type="text" class="form-control" name="akta_perceraian" value="<?php echo $data->akta_perceraian; ?>" id="phone" placeholder="Akta Perceraian" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-6" style="margin-bottom: 15px;">
									<label for="phone">Tanggal Perceraian</label> &nbsp;<code>(Wajib diisi apabila status CERAI)</code>
									<input type="date" class="form-control" name="tanggalperceraian" value="<?php echo $data->tanggalperceraian; ?>" id="phone" placeholder="Tanggal Perceraian" title="enter your phone number if any.">
							</div>
					</div>
					<div class="form-group">
							<div class="col-md-12" style="margin-bottom: 15px;">
  ...
  $(function () {
    $("#dusun").change(function() {
		...
		$.ajax({
			...
			url : '<?php echo site_url("Penduduk/get_rw_rt"); ?>',
            data : 'id=' + id,
            type : 'get',
