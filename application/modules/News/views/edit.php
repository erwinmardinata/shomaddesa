...
<form method="POST" action="<?php echo site_url('News/update'); ?>" enctype="multipart/form-data">
  <div class="row">
	<!-- left column -->
	<div class="col-md-9">
		...
		<!-- form start -->
		  ...
		  <div class="box-body">
			<div class="form-group">
			  ...
			  <input type="hidden" name="id" value="<?php echo $data->id; ?>" class="form-control" placeholder="Judul" required>
			  <input type="text" name="judul" value="<?php echo $data->judul; ?>" class="form-control" placeholder="Judul" required>
			</div>
			<div class="form-group">
	...
	<div class="col-md-3">
	  ...
	  <div class="box box-primary">
		...
		<!-- form start -->
		  <div class="box-body">
			<div class="form-group">
			  ...
			  <input type="text" name="penulis" value="<?php echo $data->penulis; ?>" class="form-control" placeholder="Penulis" required>
			</div>
			<div class="form-group">
        ...
        <div id="image" onclick="openKCFinder(this)">
          ...
          <div style="margin:90px;">
            <input type="hidden" name="thumb" value="">Click here to choose an image
          </div>
          <?php
            } else {
          ?>
          <img src="<?php echo $data->thumb; ?>" style="height: 200px;">
      ...
      <div class="form-group">
			  ...
			  <input type="date" name="date_edit" value="<?php echo $data->date_edit=="NULL"?".date('Y-m-d')":"$data->date_edit"; ?>" class="form-control" required>
			</div>
