...
<form method="POST" action="<?php echo site_url('Link_terkait/update'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-9">
		...
		<!-- form start -->
		  ...
		  <div class="box-body">
			...
			<div class="form-group">
				...
				<input type="text" value="<?php echo $data->link; ?>" name="link" class="form-control" placeholder="http://example.com">
			</div>
			<div class="form-group">
          ...
          ?>
			...
			<div class="box-footer">
				<a href="<?php echo site_url('Link_terkait'); ?>" class="btn btn btn-danger">
