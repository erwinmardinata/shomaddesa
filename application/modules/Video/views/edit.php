...
<section class="content">
  <div class="row">
    ...
    <form method="POST" action="<?php echo site_url('Video/update'); ?>" enctype="multipart/form-data">
      <div class="box-body">
      <div class="row">
        <div class="col-sm-12">
        ...
        <!-- <div class="form-group">
          ...
          <input type="text" rreadonly="readonly" name="video" class="form-control" onclick="openKCFinder(this)"
            value="<?php echo $data->video; ?>" style="width:100%;cursor:pointer" placeholder="Klik disini untuk mengupload file download" />
        </div> -->
        <div class="form-group">
          <label for="name">Link File</label>
          <input type="text" name="link_video" value="<?php echo $data->link_video; ?>" class="form-control" placeholder="http://example.com">
        </div>
        <!-- <p>
        ...
        <div class="box-footer">
          <a href="<?php echo site_url('Video'); ?>" class="btn btn-sm btn-danger">
