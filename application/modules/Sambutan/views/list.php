...
<section class="content">
  <?php if(!$data) { ?>
  <form method="POST" action="<?php echo site_url('Sambutan/insert'); ?>">
  <?php } else { ?>
  <form method="POST" action="<?php echo site_url('Sambutan/update'); ?>">
  ...
  <div class="row">
	...
	<div class="col-md-12">
      ...
      <div class="form-group">
			  ...
			  <input type="text" name="jabatan" value="<?php if(!$data) { echo ""; } else { echo $data->jabatan; } ?>" class="form-control" placeholder="Jabatan" required>
			</div>
      <div class="form-group">
			  <label for="exampleInputEmail1">Sambutan</label>
			  <textarea class="form-control" name="isi" id="content" rows="7" placeholder="Judul" required><?php if(!$data) { echo ""; } else { echo $data->isi; } ?></textarea>
			</div>
			<div class="form-group">
