...
<form method="POST" action="<?php echo site_url('Dusun/insert'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-12">
	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
          ...
          <div class="form-group">
						<div class="container row" style="margin-bottom: 15px;">
							<div class="col-md-6" style="margin-bottom: 15px;">
									...
									<select class="js-example-basic-single form-control" name="kadus" id="penduduk">
										...
										<?php foreach($penduduk as $row): ?>
											<option value="<?php echo $row->id; ?>"><?php echo $row->nik." - ".$row->nama; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
          ...
          <!-- <div class="form-group">
  				  ...
  				  <input type="number" min="0" max="100" name="rw" class="form-control" placeholder="Jumlah RW" required>
  				</div>
          <div class="form-group">
  				  <label for="name">Jumlah RT</label> <code>isi dengan angka</code>
  				  <input type="number" min="0" max="100" name="rt" class="form-control" placeholder="Jumlah RT" required>
  				</div> -->
