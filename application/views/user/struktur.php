...
<div>
	<div style="background-color: rgba(0,0,0,0.5);margin-top: 58px;">
		<div class="container">
	          ...
	          <div class="list-group" style="text-align: left;margin-bottom: 12px;">
	            <div style="font-family: bold, sans-serif, Arial;font-weight: Bold;font-size: 19px;padding-left: 18px;margin-bottom: 12px;">
	              PROFIL
							...
							?>
								<a style="font-family: Roboto-Regular;font-size: 15px;line-height: 20px;border: 0;" href="<?php echo site_url('profil/index/'.$row->id.'/'.$judul.'.html'); ?>" class="list-group-item download-file list-group-item-action judul-event">
