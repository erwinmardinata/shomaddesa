...
<div style="background-color: #FFF; padding: 25px 0;">
	<div class="container">
		<div class="container-konten">
			<div class="row">
				<div class="col-md-12">
					<h1 class="title-header text-center" style="font-weight: 900"><?php echo mb_strtoupper($foto[0]->kategori); ?></h1><br>
					<div class="value-content">
						<div class="row">
							<?php foreach($foto as $no => $row): ?>
							<div class="col-md-2" style="padding: 0">
								<div class="panel-konten" style="margin-bottom: 23px">
									<a target="_blank" href="<?php echo $row->foto; ?>" title="<?php echo $row->judul; ?>"  data-fancybox="gallery" data-caption="<?php echo $row->judul; ?>"><div class="panel-thumb fancybox img-thumbnail" style="background-image: url(<?php echo $row->foto; ?>);height:130px"></div></a>
